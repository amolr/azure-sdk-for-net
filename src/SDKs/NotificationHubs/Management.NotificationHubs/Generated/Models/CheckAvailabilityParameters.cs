...
namespace Microsoft.Azure.Management.NotificationHubs.Models
{
    ...
    public partial class CheckAvailabilityParameters
    {
        ...
        /// false.</param>
        public CheckAvailabilityParameters(string name, string location, string id = default(string), string type = default(string), string kind = default(string), IDictionary<string, string> tags = default(IDictionary<string, string>), Sku sku = default(Sku), bool? isAvailiable = default(bool?))
        {
            Id = id;
            Name = name;
            Type = type;
